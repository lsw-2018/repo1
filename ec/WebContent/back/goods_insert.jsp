					...
					<div class="card alert" style="margin-top: -50px;">
						<div class="card-header">
							...
							<div class="booking-system-item">
								<form id="ff"
									action="${pageContext.request.contextPath }/goods/insert.action"
										...
										<div class="col-lg-4" >
											<div class="form-group">
												<input class="form-control input-lg " placeholder="商品名称"
													...
													<div class="form-group">
												描述：
												<textarea name="miaoshu" class="form-control" rows="3"></textarea>
											</div>
													<div class="checkbox">
												颜色：<label class="checkbox-inline"> <input
													type="checkbox" name="color" value="白"> 白
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="color" value="蓝"> 蓝
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="color" value="黑"> 黑
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="color" value="粉"> 粉
												</label><br /> <br />
											</div>
												...
												<input class="form-control input-lg " placeholder="库存" id="num" name="num" /> 
												<br/>
										...
										<div class="col-lg-4">
											<div class="form-group">
													...
													<input type="number" class="form-control"
														id="exampleInputAmount" placeholder="原价" name="oldprice">
													<div class="input-group-addon">.00</div>
													</div><br>
													<div class="input-group">
													<div class="input-group-addon">$</div>
													<input type="number" class="form-control"
														id="exampleInputAmount" placeholder="现价" name="newprice">
													<div class="input-group-addon">.00</div>
												    </div>
												    </div>
												    <div class="form-group">
												<input type="text"  name="type"
													class="form-control" placeholder="商品类型"/>
											</div>
											 <label class="checkbox-inline"> 
												 <input type="checkbox" name="ishot" value="是">热销商品
												</label> 
												<label class="checkbox-inline"> 
												 <input type="checkbox" name="isgood" value="是">精选商品
												</label> 
												<label class="checkbox-inline"> 
												<input type="checkbox" name="istuijian" value="是">推荐商品
												</label> <br/><br/>
												...
												<div class="col-lg-10">
											参数与配图：
												<textarea class="form-control" rows="3" name="parm"></textarea>
												</div>
										</div>
