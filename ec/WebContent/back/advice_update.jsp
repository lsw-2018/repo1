					...
					<div class="card alert" style="margin-top: -50px;">
						<div class="card-header">
							...
							<div class="booking-system-item">
								<form id="ff"
									action="${pageContext.request.contextPath }/advice/update.action"
									method="post" enctype="multipart/form-data">
								 <input type="hidden" value="${updateadvice.id }" name="id"/>
									<div class="row">
										<div class="col-lg-4" >
											<div class="form-group">
												<input class="form-control input-lg " placeholder="标题"
													id="name" value="${updateadvice.title}" name="title" style="margin-left:30px;"/>
													</div>
													<div class="form-group">
												...
												<div class="col-lg-10">
											内容：
												<textarea class="form-control" rows="3" name="content">${updateadvice.content}</textarea>
												</div>
										</div>
										</div>
								</div>
